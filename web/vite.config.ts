...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mrttwt10-yha2rp-test",
        short_name: "Browser Canary e2e-create-mrttwt10-yha2rp-test",
        description: "Browser Canary e2e-create-mrttwt10-yha2rp-test — free forever",
        start_url: "/",
        display: "standalone",
